...
function plaugeToggle() {
	document.getElementById("game-container").style.backgroundImage=url('plauge.jpg');
    document.getElementById("plauge").classList.toggle("active");
}

function badPlayer() {
    document.getElementById("bad-player").classList.toggle("active");
}
